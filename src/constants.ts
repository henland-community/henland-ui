...
export const BANNER_URL =
  'https://raw.githubusercontent.com/henland-community/henland-status/main'
...
export const SWAP_TYPE_HENLAND = 'HENLAND'

export const MAIN_MARKETPLACE_CONTRACT = MARKETPLACE_CONTRACT_HENLAND // the one that is used for swapping
export const MAIN_MARKETPLACE_CONTRACT_SWAP_TYPE = SWAP_TYPE_HENLAND
