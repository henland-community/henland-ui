        ...
        <>
          ...
          {(isRestrictedUser || isUnderReviewUser) && (
            <div className={styles.restricted}>
              ...
              <p>
                Contact the Henland moderators on
              ...
              <p>
                ...
                <Button
                  inline
                  small
                  href="https://github.com/henland-community/henland-docs/wiki/Core-Values-Code-of-Conduct-Terms-and-Conditions#3-terms-and-conditions---account-restrictions"
                >
                  Henland Terms and Conditions
                </Button>
              </p>
            </div>
          )}
